...
Write-Progress -Activity $cppslt -Status "Running SuperLTI Script..." -PercentComplete 40
...
Write-Progress -Activity $cppslt -Status "Removing SuperLTI Directory..." -PercentComplete 95 -SecondsRemaining 10
